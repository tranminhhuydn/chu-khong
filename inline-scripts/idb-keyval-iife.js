...
function separateSote (namedb) {
  var db = new idbKeyval.Store(namedb)
  function set(key,value){
    return idbKeyval.set(key,value,db)
  }
  function get(key){
    return idbKeyval.get(key,db)
  }
  function del(key){
    return idbKeyval.del(key,db)
  }
  function clear(){
    return idbKeyval.clear(db)
  }
  function keys(){
    return idbKeyval.keys(db)
  }
  var exports= {}
  exports.get = get;
  exports.set = set;
